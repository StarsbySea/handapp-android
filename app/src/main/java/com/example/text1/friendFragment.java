...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.database_layout, null);
        initView();
        initData();
        initAdapter();
        return v;
    ...
    private void initData() {
        mList = new ArrayList<>();
        String[] str= new String[]{"部队编制","财政贸易","称谓","成语虚词","政党机关","法律","工业建筑","工作",
                "国防公安","教育","科学","空间","矿物","历史","民族","农牧副渔",
                "其他","人品德才","日用品","生物","时间","食品","事情事态","数量词","数目","数学","体育"
                ,"天体气象","卫生","文化","武器装备","物理","心理","物质性能","姓氏","衣物","哲学","职业","植物",
                "洲洋国家名称","字母"};
        for (String s : str) {
...
//        return inflater.inflate(R.layout.database_layout, container, false);
//    }
