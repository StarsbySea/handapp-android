...
//        return new File(mContext.getExternalFilesDir("images"), ".jpg");
        String cameraPath = context.getExternalCacheDir().getPath();
//        String cameraPath = context.getExternalCacheDir().getPath() + File.separator + "DCIM" + File.separator + "Camera";
        File cameraFolder = new File(cameraPath);
        if (!cameraFolder.exists()) {
            cameraFolder.mkdirs();
        }
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyyMMdd_HHmmss");
        System.out.println("This is getPicturePath"+cameraFolder.getAbsolutePath() + File.separator + "IMG_" + simpleDateFormat.format(new Date()) + ".jpg");
