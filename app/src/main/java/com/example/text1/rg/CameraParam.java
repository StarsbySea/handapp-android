...
import com.example.text1.rg.CameraActivity;
...
public class CameraParam implements Parcelable {
    ...
    public String getPictureTempPath() {
        ...
        System.out.println("This is getPictureTempPath " + file.getParent() + File.separator + newName);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            this.picturePath = Tools.getPicturePath(context);
        }
