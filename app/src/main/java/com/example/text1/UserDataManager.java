...
//    public static final String VIBRATE = "vibrate";
    ...
    private static class DataBaseManagementHelper extends SQLiteOpenHelper {
        ...
        @Override
        public void onCreate(@NonNull SQLiteDatabase db) {//android提供了一个名为sqlitedatabase的类该类封装了一些操作数据库的API
            Log.i(TAG,"db.getVersion()="+db.getVersion());
            db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME + ";");//execsql可以执行select、update、insert、delete语句
    ...
    //添加新用户，即注册
    public long insertUserData(@NonNull UserData userData) {
    ...
    //更新用户信息，如修改密码
    public boolean updateUserData(@NonNull UserData userData) {
...
//        return mSQLiteDatabase.update(TABLE_NAME, values,null, null) > 0;
        return mSQLiteDatabase.update(TABLE_NAME, values, ID + "=" + "1", null) > 0;
    }
    //
